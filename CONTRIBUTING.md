# Contributing to KitoMediaPlayer
...
3. Make your change. Follow
   [KitoMediaPlayer's engineering standards](https://github.com/WykSofts-Inc/KitoMediaPlayer/blob/main/docs/ENGINEERING_STANDARDS.md) —
